...
Son kullanıcılar için önerilen yöntem, GitHub üzerindeki **Releases** bölümünden Windows kurulum paketini indirmektir.

| Paket | Açıklama | Dosya adı |
|---|---|---|
| Windows Setup `.exe` | Kurulum sihirbazı ile standart Windows kurulumu | `Nymphaea_IDE_1.0.0_x64-setup.exe` |
| Windows MSI `.msi` | MSI tabanlı kurulum paketi | `Nymphaea_IDE_1.0.0_x64_en-US.msi` |

İndirme bağlantıları, kurulum dosyaları GitHub Releases bölümüne yüklendikten sonra aşağıdaki biçimde kullanılabilir:

```text
https://github.com/RodinaAmrMukhtar/nymphaea-ide/releases/latest/download/Nymphaea_IDE_1.0.0_x64-setup.exe
https://github.com/RodinaAmrMukhtar/nymphaea-ide/releases/latest/download/Nymphaea_IDE_1.0.0_x64_en-US.msi
```

Kurulum adımları:

1. **Releases** bölümünden en güncel sürümü açın.
2. `.exe` veya `.msi` kurulum dosyasını indirin.
3. Kurulum dosyasını çalıştırın.
4. Kurulum tamamlandıktan sonra Başlat menüsünden **Nymphaea IDE** uygulamasını açın.

> Nymphaea IDE, Windows 10 ve Windows 11 üzerinde çalışacak şekilde paketlenir.

### Dosya doğrulama

Kurulum paketleri yayımlandığında SHA-256 değerleri paylaşılabilir. Bu değerler, indirilen dosyanın bütünlüğünü kontrol etmek için kullanılır.

| Dosya | SHA-256 |
|---|---|
| `Nymphaea_IDE_1.0.0_x64-setup.exe` | `73e2e6eb42be130a32d3610323e3820b6ec5560ab0803c283d060b9f8430e382` |
| `Nymphaea_IDE_1.0.0_x64_en-US.msi` | `8a8d7837b51ee4944e2e7dc91db248530f89f6512cc57036521d29856f476fb3` |
...
Bu yönüyle proje; portfolyo, akademik sunum, staj başvurusu ve yazılım mühendisliği pratiği açısından değerlendirilebilir niteliktedir.

---

## Yol Haritası

Geliştirilmesi planlanan başlıklar:

- Tanılar panelinin daha kapsamlı hâle getirilmesi,
- Türkçe karakter kodlamasının tüm terminal senaryolarında iyileştirilmesi,
- Dil sunucusu desteği,
- Otomatik tamamlama ve gelişmiş sözdizimi desteği,
- Daha kapsamlı proje gezgini,
- Entegre dokümantasyon paneli,
- Daha fazla örnek proje,
- Kurulum ve güncelleme deneyiminin iyileştirilmesi,
- Linux ve macOS paketlerinin hazırlanması.

---

## Lisans

Bu proje akademik ve portfolyo amaçlı geliştirilmiştir. Lisans koşulları için `LICENSE` dosyasına bakınız.
...
Nymphaea IDE, Nymphaea programlama dili ekosisteminin masaüstü geliştirme ortamı olarak tasarlanmıştır.
